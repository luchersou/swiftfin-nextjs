...
function RevenueCard() {
  return (
    ...
    >
      <CardContainer>
        <CardBody className="bg-slate-900/70 backdrop-blur-3xl border border-slate-700/50 rounded-2xl w-[280px] h-[350px] shadow-slate-900/50 overflow-hidden">
...
function InsightsCard() {
  ...
  return (
    ...
    >
      <CardContainer>
        <CardBody className="bg-slate-900/70 backdrop-blur-3xl border border-slate-700/50 rounded-2xl w-[260px] h-[350px] shadow-slate-900/50 overflow-hidden">
          <CardItem translateZ="50">
