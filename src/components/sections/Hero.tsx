  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 sm:px-8 lg:px-12 xl:px-24 py-12 lg:py-0 overflow-hidden bg-gradient-to-br from-slate-950 via-slate-500 to-slate-700">
      ...
      <div className="relative z-10 w-full max-w-2xl text-center lg:text-left">
        ...
        >
        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight mb-4 sm:mb-6 pt-25">
        ...
        <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0">
          ...
          {[
            ...
            <div key={i} className="flex flex-col items-center sm:items-start gap-2">
              <div className="p-2 bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-lg">
                <feature.icon size={20} className="text-slate-100" />
              </div>
      ...
      <div className="hidden lg:block relative w-full max-w-[400px] lg:max-w-[500px] xl:max-w-[600px] aspect-square flex-shrink-0">
        ...
        >
          <CardContainer>
            <CardBody className="bg-slate-900/70 backdrop-blur-3xl border border-slate-700/50 rounded-2xl w-[320px] shadow-5xl shadow-slate-900/50 overflow-hidden">
              
              <CardItem translateZ="50">
                <div className="px-4 py-3 flex items-center gap-3 border-b border-slate-700/30 bg-slate-800/60">
                  <div className="flex gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-red-500"></span>
                    <span className="w-2.5 h-2.5 rounded-full bg-yellow-500"></span>
                    <span className="w-2.5 h-2.5 rounded-full bg-green-500"></span>
                  </div>
                  <div className="flex-1 bg-slate-950/30 rounded-lg px-3 py-1 text-[10px] text-slate-500 font-mono">
              ...
              <div className="flex">
                <CardItem translateZ="70">
                  <div className="w-12 py-5 border-r border-slate-700/30 flex flex-col items-center gap-5 bg-slate-950/30">
                ...
                <CardItem translateZ="100" className="p-4 w-full">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold text-white">$47.5K</div>
                  ...
                  <div className="mt-3 flex items-end gap-1.5 h-20 bg-slate-950/30 rounded-lg p-2">
        ...
        <motion.div
          ...
          className="absolute right-[10%] top-[25%] rotate-[4deg] z-20 hover:z-50 transition-all hover:scale-105"
        >
          <CardContainer>
            <CardBody className="bg-slate-900/70 backdrop-blur-3xl border border-slate-700/50 rounded-2xl w-[300px] shadow-5xl shadow-slate-900/50 overflow-hidden">
              ...
              <CardItem translateZ="90" className="p-4">
                <div className="flex items-center gap-2 mb-4">
                  <div className="p-1.5 bg-purple-500/20 backdrop-blur-xl border border-purple-500/30 rounded-lg">
                    <CreditCard size={14} className="text-purple-400" />
                  </div>
                  <div>
                    <h3 className="text-xs font-bold text-white">Transactions</h3>
                    <p className="text-[9px] text-slate-500">Today's activity</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-2 bg-slate-950/30 rounded-lg hover:bg-slate-950/50 transition-colors">
                      <div>
                        <p className="text-xs font-medium text-white">{tx.name}</p>
                        <p className="text-[9px] text-slate-600">{tx.time}</p>
                      </div>
                      <span className={`text-xs font-semibold ${tx.amount > 0 ? "text-emerald-400" : "text-slate-400"}`}>
                ...
                <div className="mt-3 pt-3 border-t border-slate-700/30 flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-white">$18,447.19</span>
                </div>
              </CardItem>
            </CardBody>
          </CardContainer>
        ...
        <motion.div
          ...
          className="absolute left-[25%] bottom-[15%] rotate-[-3deg] z-10 hover:z-50 transition-all hover:scale-105"
        >
          <CardContainer>
            <CardBody className="bg-slate-900/70 backdrop-blur-3xl border border-slate-700/50 rounded-2xl w-[280px] shadow-5xl shadow-slate-900/50 overflow-hidden">
              ...
              <CardItem translateZ="90" className="p-4">
                <div className="flex items-center gap-2 mb-4">
                  <div className="p-1.5 bg-cyan-500/20 backdrop-blur-xl border border-cyan-500/30 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {[
                    ...
                    <div key={i} className="p-2 bg-slate-950/30 rounded-lg">
                      <p className="text-[9px] text-slate-500 mb-1">{stat.label}</p>
                      <p className="text-sm font-bold text-white">{stat.value}</p>
                      <p className={`text-[9px] flex items-center gap-0.5 mt-0.5 ${stat.up ? "text-emerald-400" : "text-slate-400"}`}>
